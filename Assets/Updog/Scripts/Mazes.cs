...
using System.Linq;
using UnityEngine;
using ColorDictionary = System.Collections.Generic.Dictionary<EmikBaseModules.Tuple<UnityEngine.Color, UnityEngine.Color>, string[]>;
using ColorCombination = EmikBaseModules.Tuple<UnityEngine.Color, UnityEngine.Color>;
using IntTuple = EmikBaseModules.Tuple<int, int>;
using MazeTuple = EmikBaseModules.Tuple<System.Text.StringBuilder[], string[]>;
using String = System.Text.StringBuilder;
using WordTuple = EmikBaseModules.Tuple<Updog.Spelling, Updog.Casing>;
